...
declare const SexplainedBackendApplication_base: (new (...args: any[]) => {
    [x: string]: any;
    projectRoot: string;
...
export declare class SexplainedBackendApplication extends SexplainedBackendApplication_base {
